...
export const prismaFindManyToken = async (
  args: Prisma.TokenFindManyArgs<DefaultArgs>,
) => {
  return prisma.token
    .findMany(args)
    .finally(async () => await prisma.$disconnect())
...
export const prismaFindUniqueToken = async (
  args: Prisma.TokenFindUniqueArgs<DefaultArgs>,
) => {
  return prisma.token
    .findUnique(args)
    .finally(async () => await prisma.$disconnect())
...
export const prismaCreateToken = async (
  args: Prisma.TokenCreateArgs<DefaultArgs>,
) => {
  return prisma.token
    .create(args)
    .finally(async () => await prisma.$disconnect())
...
export const prismaUpdateToken = async (
  args: Prisma.TokenUpdateArgs<DefaultArgs>,
) => {
  try {
    const response: any = await prisma.token
      .update(args)
      .finally(async () => await prisma.$disconnect())
    return response
  } catch (error) {
...
export const prismaDeleteToken = async (
  args: Prisma.TokenDeleteManyArgs<DefaultArgs>,
) => {
  return prisma.token
    .deleteMany(args)
    .finally(async () => await prisma.$disconnect())
...
export const prismaUpsertToken = async (
  ...
  return prisma.token.upsert(args)
}
